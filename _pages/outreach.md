...
For more details about the event, click [here <i class="fa fa-external-link" aria-hidden="true"></i>]( https://www.sciencecityday.de/programm/wave-field-huepfburg/) or have a look to other [blog post](({{ site.url }}{{ site.baseurl }}/posts/#taylorswift)). 
