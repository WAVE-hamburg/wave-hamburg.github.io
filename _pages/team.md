...
feature_row3:
  ...
  - image_path: /assets/images/Team/Wanda Vossius.png
    ...
    <strong>Affiliation:</strong> Institute of Automation Technology<br>
      ...
      <strong>Collaborations:</strong> <a href="https://www.ligo.org/">LIGO-Virgo-Kagra</a>, <a href="https://www.et-gw.eu/">Einstein Telescope</a>'
  - image_path: /assets/images/Team/Spiridon_beis.png
    alt: "Spiridon Beis"
    title: "Spiridon Beis"
...
<div style="display: flex; align-items: center; margin-top: 20px;">
  ...
  <!-- Rundes Bild -->
  <img src="{{ site.url }}{{ site.baseurl }}/assets/images/Team/ConnyHammer_rund.png" alt="Prof. Dr. Conny Hammer" style="width: 150px; height: 150px; border-radius: 50%; margin-right: 15px;">
...
<div style="display: flex; align-items: center; margin-top: 20px;">
  ...
  <!-- Rundes Bild -->
  <img src="{{ site.url }}{{ site.baseurl }}/assets/images/Team/svea_kreutzer_rd.jpeg" alt="Svea Kreutzer" style="width: 150px; height: 150px; border-radius: 50%; margin-right: 15px;">

  <!-- Aufzählungstext -->
  <div style="line-height: 1.4; font-family: 'Roboto', 'Segoe UI', 'Helvetica Neue', 'Lucida Grande', Arial, sans-serif; font-size: 15pt;">
    <p style="margin: 0; font-size: 18pt;"><strong>Svea Kreutzer</strong></p>
    <p style="margin: 0;">
      <strong>Affiliation:</strong> Institute of Geophysics<br>
      <strong>Interests:</strong> Svea focuses on ocean-generated secondary microseisms and its detectability at inland seismic stations in northern Germany and the WAVE network, in order to understand how those seismic waves interact with the accelerator structures at DESY and EuXFEL.
    </p>
  </div>
...
<div style="display: flex; align-items: center; margin-top: 20px;">
  ...
  <!-- Rundes Bild -->
  <img src="{{ site.url }}{{ site.baseurl }}/assets/images/Team/Francesca_Badaracco.png" alt="Dr. Francesca Badaracco" style="width: 150px; height: 150px; border-radius: 50%; margin-right: 15px;">
